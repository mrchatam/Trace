...
- [experiments/README.md](experiments/README.md) — experiment index / how to run
- [experiments/RESULTS.md](experiments/RESULTS.md) — scored E01–E03 portfolio (historical DF batch ledgers not in tree)
...
- [docs/phases/phase-18-fts-clone-honesty/README.md](docs/phases/phase-18-fts-clone-honesty/README.md) — Phase 18 FTS + clone honesty (**complete**; DR-HANDOFF `no successor`)
...
- [docs/phases/phase-18-fts-clone-honesty/DR-HANDOFF.md](docs/phases/phase-18-fts-clone-honesty/DR-HANDOFF.md) — `no successor` (phase closed)
...
- [experiments/ab-incident-tracker/](experiments/ab-incident-tracker/) — ab incident tracker dogfood (in-tree)
- [experiments/ab-library-hold-desk/](experiments/ab-library-hold-desk/) — library hold desk dogfood (in-tree)
- [experiments/ab-p25-gap-pass-validation/](experiments/ab-p25-gap-pass-validation/) — P25 gap-pass validation (in-tree)
