...
1. **Pick work:** trace_tasks (capped page; default limit 50 — pass cursor/limit/work_state, avoid all=true) → trace_context task_id=<uuid> [query=<optional agent query>]
